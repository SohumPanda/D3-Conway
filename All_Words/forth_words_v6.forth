...
: count_neighbour_array_occupancy n square 0 do neighbours i + c@
	case 
...
{ 20 constant n }  { -------------  this has been defined earlier to make the count_neighbour_array_occupancy words work }
n 1- constant n-1
n n-1 * constant n(n-1)
n square 1- constant n^2-1 
n make_array drop value Life_Array_1 


{ n make_array drop constant neighbours }  { ------------- this has been defined earlier to make the count_neigbour_array_occupancy work }  
...
n make_array drop value Life_Array_2
...
: count_alive_1 n square 0 do Life_Array_1 i + c@
	case 
	 1 of alive_1 0 + @ 1+ alive_1 0 + !  endof
	 endcase
	 loop ;
	 
: count_alive_2 n square 0 do Life_Array_1 i + c@
	case 
...
n 2 * make_array drop value Life_Array32
...
: update_show 
	...
	neighbours n show_array drop drop 
	next_gen
	life_array_2 n show_array drop drop 
	life_array_2 life_array_1 n square move
; 
...
: reset_life_array_1 cr life_array_1 n square 0 fill ;


: reset_life_array_2 cr life_array_2 n square 0 fill ;
